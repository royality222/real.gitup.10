    ...
    <div style="width: 100%; height: 570px; display: flex">
      ...
      >
        ...
        >
          ...
          <h2 style="font-family: Garamond, serif; margin-top:10px">Existing Courses
            
          </h2>
          <div>
            <?php
          include 'db.php';
          $result = $conn->query("SELECT * FROM courses"); while ($row =
            ...
            <li>
              ...
              >
                ...
                <button type='submit' style='background-color: green; border: none;
                border-radius: 10px; padding-right: 10px; padding-left: 10px; margin-top:20px; font-size:20px; font-family: Garamond, serif; margin-left:20px' onclick='confirmDelete()'>Delete</button>
              </form>
            </li>
            "; } ?>
          </div>
